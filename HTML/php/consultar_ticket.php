...
<head>
    <meta charset="UTF-8">
    <title>MoBaTickets - Resultados de Consulta por Sector</title>
...
<body>
    <div class="contenedor-principal">
        ...
        <!--Obtiene el sector a buscar, por medio de una consulta sql busca tickets por ese secttor, luego muestra los resultados y se despliega el html con los resultados imprimiendose, 
        ...
        if(isset($_POST['sector'])){
            $busqueda = $_POST['sector'];
            echo '<p class="subtitulo-consulta">Consultando tickets del sector: <strong>' . htmlspecialchars($busqueda) . '</strong></p>';
            
            $pregunta = "SELECT * FROM ticket WHERE sector='".pg_escape_string($conexion, $busqueda)."';";
            ...
            if ($respuesta && pg_num_rows($respuesta) > 0) {
                ...
                echo '<div class="sin-resultados">No se encontraron resultados para el sector seleccionado</div>';
            }
        } else {
            echo '<div class="error-mensaje">Error: No se proporcionó sector para la consulta</div>';
        }
        ?>
